...
checksums: seed 3407 for CPI classification and seed 42 for pooled compound
ranking. Large `.pt` files remain local and should be uploaded as GitHub Release
assets rather than ordinary Git blobs.
